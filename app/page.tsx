        ...
        <div className="w-full md:w-[52%] p-6 md:p-12 backdrop-blur-xl bg-white/5 rounded-3xl border border-white/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-8 md:mt-12">
            {[
              ...
              <div
                key={feature.title}
                className="flex items-start space-x-4 bg-gradient-to-br from-blue-900/40 to-blue-950/40 
                p-4 md:p-8 rounded-2xl border border-cyan-500/20 shadow-lg 
                hover:from-blue-900/50 hover:to-blue-950/50 hover:border-cyan-500/40 
          ...
          <div className="backdrop-blur-xl bg-white/10 p-6 md:p-12 rounded-3xl border border-white/20 shadow-[0_0_50px_rgba(0,0,0,0.3)] w-full">
            <div className="space-y-6 md:space-y-8">
              ...
              <button
                ...
                disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:bg-white/5"
              >
                {isGoogleLoading ? (
                  <>
                    <svg
