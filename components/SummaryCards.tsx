  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
      <div className="relative overflow-hidden rounded-xl 
        ...
        p-4 sm:p-6 hover:from-emerald-900/50 hover:to-emerald-950/50 
        hover:border-emerald-500/50 transition-all duration-300 group">
        <div className="relative z-10">
          <div className="flex justify-between items-center">
            <h2 className="text-base sm:text-lg font-semibold text-emerald-300">Total Income</h2>
            <button 
          ...
          <p className="text-2xl sm:text-3xl font-bold text-white/90 mt-2 group-hover:scale-105 transition-transform">
      ...
      <div className="relative overflow-hidden rounded-xl 
        ...
        p-4 sm:p-6 hover:from-rose-900/50 hover:to-rose-950/50 
        hover:border-rose-500/50 transition-all duration-300 group">
        <div className="relative z-10">
          <h2 className="text-base sm:text-lg font-semibold text-rose-300">Total Expenses</h2>
          <p className="text-2xl sm:text-3xl font-bold text-white/90 mt-2 group-hover:scale-105 transition-transform">
      ...
      <div className="relative overflow-hidden rounded-xl 
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-center">
            <h2 className="text-base sm:text-lg font-semibold text-blue-300">Savings</h2>
            <button 
