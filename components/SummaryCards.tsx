  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
      ...
      >
        <div className="relative z-10">
          <div className="flex justify-between items-center">
            <h2 className="text-base sm:text-lg font-semibold text-rose-300">
              Total Expenses
            </h2>
            <button
      ...
      >
        <div className="relative z-10">
          <div className="flex justify-between items-center">
            <h2 className="text-base sm:text-lg font-semibold text-blue-300">
              Savings
            </h2>
            <button
